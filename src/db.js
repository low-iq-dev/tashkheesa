...
async function seedPricingData() {
  ...
  var egPricing = {
    ...
    // ── ORTHOPEDICS (new — all green) ──────────────────────────────────────────
    orth_xray_review: { cost: 900, status: 'active' },
    orth_mri_review: { cost: 3500, status: 'active' },
    orth_ct_review: { cost: 2800, status: 'active' },
    orth_spine_imaging: { cost: 3500, status: 'active' },
    orth_knee_mri: { cost: 3200, status: 'active' },
    orth_shoulder_mri: { cost: 3200, status: 'active' },
    orth_hip_mri: { cost: 3200, status: 'active' },
    orth_fracture_review: { cost: 2500, status: 'active' },
    orth_preop_opinion: { cost: 4500, status: 'active' },
    orth_postop_review: { cost: 3000, status: 'active' },
    orth_bone_density: { cost: 1200, status: 'active' },
    // ── GASTROENTEROLOGY (new — all green) ────────────────────────────────────
    gastro_endoscopy: { cost: 3000, status: 'active' },
    gastro_colonoscopy: { cost: 3000, status: 'active' },
    gastro_liver_us: { cost: 1500, status: 'active' },
    gastro_liver_mri: { cost: 6000, status: 'active' },
    gastro_mrcp: { cost: 6500, status: 'active' },
    gastro_liver_biopsy: { cost: 7000, status: 'active' },
    gastro_fibroscan: { cost: 2500, status: 'active' },
    gastro_hbv_hcv: { cost: 2000, status: 'active' },
    gastro_ibd_review: { cost: 4000, status: 'active' },
    gastro_capsule_endo: { cost: 7000, status: 'active' },
    // ── ENDOCRINOLOGY (new — all green) ────────────────────────────────────────
    endo_thyroid_full: { cost: 1200, status: 'active' },
    endo_thyroid_us: { cost: 1500, status: 'active' },
    endo_diabetes_mgmt: { cost: 2000, status: 'active' },
    endo_adrenal: { cost: 3500, status: 'active' },
    endo_pituitary_mri: { cost: 3500, status: 'active' },
    endo_pcos: { cost: 2000, status: 'active' },
    endo_osteoporosis: { cost: 1800, status: 'active' },
    endo_lipid_mgmt: { cost: 1200, status: 'active' },
    endo_obesity_review: { cost: 2000, status: 'active' },
    endo_growth_hormone: { cost: 3500, status: 'active' },
    // ── PULMONOLOGY (new — all green) ──────────────────────────────────────────
    pulm_cxr_review: { cost: 550, status: 'active' },
    pulm_ct_chest: { cost: 3500, status: 'active' },
    pulm_hrct: { cost: 5000, status: 'active' },
    pulm_pft_review: { cost: 2500, status: 'active' },
    pulm_sleep_study: { cost: 5000, status: 'active' },
    pulm_bronchoscopy: { cost: 4500, status: 'active' },
    pulm_post_covid: { cost: 2500, status: 'active' },
    pulm_tb_workup: { cost: 2500, status: 'active' },
    pulm_v_q_scan: { cost: 4500, status: 'active' },
    // ── NEPHROLOGY (new — all green) ───────────────────────────────────────────
    neph_kidney_function: { cost: 1200, status: 'active' },
    neph_kidney_biopsy: { cost: 7000, status: 'active' },
    neph_kidney_us: { cost: 1500, status: 'active' },
    neph_ckd_review: { cost: 2500, status: 'active' },
    neph_dialysis_review: { cost: 4000, status: 'active' },
    neph_proteinuria: { cost: 2500, status: 'active' },
    neph_stone_review: { cost: 2800, status: 'active' },
    neph_htn_workup: { cost: 2500, status: 'active' },
    // ── OB/GYN (new — all green) ───────────────────────────────────────────────
    obgyn_obs_us: { cost: 1500, status: 'active' },
    obgyn_fetal_echo: { cost: 4000, status: 'active' },
    obgyn_gynae_us: { cost: 1500, status: 'active' },
    obgyn_pap_smear: { cost: 900, status: 'active' },
    obgyn_mri_pelvis: { cost: 5500, status: 'active' },
    obgyn_fertility_panel: { cost: 2000, status: 'active' },
    obgyn_fibroid_review: { cost: 2500, status: 'active' },
    obgyn_prenatal_labs: { cost: 1200, status: 'active' },
    obgyn_hsg: { cost: 2000, status: 'active' },
    // ── DERMATOLOGY (new — all green) ─────────────────────────────────────────
    derm_clinical_photos: { cost: 1800, status: 'active' },
    derm_dermoscopy: { cost: 2500, status: 'active' },
    derm_skin_biopsy: { cost: 4000, status: 'active' },
    derm_patch_test: { cost: 2000, status: 'active' },
    derm_autoimmune_skin: { cost: 4000, status: 'active' },
    derm_hair_loss: { cost: 2000, status: 'active' },
    derm_psoriasis: { cost: 2000, status: 'active' },
    derm_wound_review: { cost: 2000, status: 'active' },
    // ── OPHTHALMOLOGY (new — all green) ────────────────────────────────────────
    opht_oct_review: { cost: 2500, status: 'active' },
    opht_fundus_photo: { cost: 2000, status: 'active' },
    opht_visual_field: { cost: 1800, status: 'active' },
    opht_glaucoma_review: { cost: 3500, status: 'active' },
    opht_retinal_review: { cost: 3500, status: 'active' },
    opht_fluorescein_angio: { cost: 4500, status: 'active' },
    opht_diabetic_retina: { cost: 2500, status: 'active' },
    opht_mri_orbit: { cost: 5000, status: 'active' },
    opht_preop_opinion: { cost: 4000, status: 'active' },
    // ── UROLOGY (new — all green) ──────────────────────────────────────────────
    urol_prostate_review: { cost: 2500, status: 'active' },
    urol_psa_review: { cost: 1500, status: 'active' },
    urol_mri_prostate: { cost: 5000, status: 'active' },
    urol_kidney_ct: { cost: 2800, status: 'active' },
    urol_bladder_us: { cost: 1500, status: 'active' },
    urol_cystoscopy: { cost: 4000, status: 'active' },
    urol_urodynamics: { cost: 4500, status: 'active' },
    urol_stone_review: { cost: 2500, status: 'active' },
    urol_scrotal_us: { cost: 1800, status: 'active' },
    // ── HEMATOLOGY (new — all green) ───────────────────────────────────────────
    hema_cbc_full: { cost: 1200, status: 'active' },
    hema_coag_panel: { cost: 2000, status: 'active' },
    hema_bone_marrow: { cost: 10000, status: 'active' },
    hema_flow_cytometry: { cost: 9000, status: 'active' },
    hema_lymphoma_staging: { cost: 9000, status: 'active' },
    hema_anemia_workup: { cost: 2500, status: 'active' },
    hema_thrombophilia: { cost: 5000, status: 'active' },
    hema_sickle_cell: { cost: 2500, status: 'active' },
    hema_immunoglobulins: { cost: 5000, status: 'active' },
    // ── PSYCHIATRY (not at Shifa — keep as not_available) ──────────────────────
    psych_diagnosis_review: { cost: null, status: 'not_available' },
    psych_medication_review: { cost: null, status: 'not_available' },
    psych_assessment_review: { cost: null, status: 'not_available' },
    psych_adhd_review: { cost: null, status: 'not_available' },
    psych_anxiety_review: { cost: null, status: 'not_available' },
    psych_depression_review: { cost: null, status: 'not_available' },
    psych_bipolar_review: { cost: null, status: 'not_available' },
    psych_autism_review: { cost: null, status: 'not_available' },
    psych_substance_review: { cost: null, status: 'not_available' },
    psych_mri_brain_psych: { cost: null, status: 'not_available' }
  };
