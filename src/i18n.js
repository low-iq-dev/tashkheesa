...
const en = {
  ...
  'auth.login.method_label': 'Sign-in method',
  'auth.login.tab_email': 'Email & password',
  'auth.login.tab_phone': 'Phone number',
  'auth.login.phone_label': 'Phone number',
  'auth.login.country_label': 'Country code',
  'auth.login.send_code': 'Send code',
  'auth.login.otp_sent': 'Enter the 6-digit code sent to',
  'auth.login.otp_label': '6-digit code',
  'auth.login.verify_signin': 'Verify & sign in',
  'auth.login.back': 'Back',
  'auth.login.resend': 'Resend code',
  'auth.login.resend_in': 'Resend in',
  'auth.login.phone_required': 'Enter your phone number.',
  'auth.login.otp_invalid': 'The code is incorrect or expired.',
  'auth.login.otp_error': 'Something went wrong. Please try again.',
  'auth.login.rate_limited': 'Too many attempts. Please wait a bit and try again.',
  'auth.login.seconds_suffix': 's',
  ...
  'patient.new_case.sla_standard': '48h (Standard)',
  'patient.new_case.sla_priority': '4h (Urgent)',
  ...
  'refund.status.auto_approved': 'Refund approved — we\'ll send your InstaPay transfer within 3–5 business days.',
  'refund.status.approved': 'Refund approved — we\'ll send your InstaPay transfer within 3–5 business days.',
...
const ar = {
  ...
  'auth.login.method_label': 'طريقة تسجيل الدخول',
  'auth.login.tab_email': 'البريد وكلمة المرور',
  'auth.login.tab_phone': 'رقم الهاتف',
  'auth.login.phone_label': 'رقم الهاتف',
  'auth.login.country_label': 'رمز الدولة',
  'auth.login.send_code': 'إرسال الرمز',
  'auth.login.otp_sent': 'أدخل الرمز المكوّن من 6 أرقام المُرسل إلى',
  'auth.login.otp_label': 'الرمز المكوّن من 6 أرقام',
  'auth.login.verify_signin': 'تأكيد وتسجيل الدخول',
  'auth.login.back': 'رجوع',
  'auth.login.resend': 'إعادة إرسال الرمز',
  'auth.login.resend_in': 'إعادة الإرسال خلال',
  'auth.login.phone_required': 'أدخل رقم هاتفك.',
  'auth.login.otp_invalid': 'رمز التحقق غير صحيح أو منتهي.',
  'auth.login.otp_error': 'حدث خطأ. حاول مرة أخرى.',
  'auth.login.rate_limited': 'محاولات كثيرة. انتظر قليلاً ثم حاول.',
  'auth.login.seconds_suffix': 'ث',
  ...
  'patient.new_case.sla_standard': '48 ساعة (قياسي)',
  'patient.new_case.sla_priority': '4 ساعات (عاجل)',
  ...
  'refund.status.auto_approved': 'تم اعتماد الاسترداد — هنحوّللك المبلغ عبر إنستاباي خلال 3–5 أيام عمل.',
  'refund.status.approved': 'تم اعتماد الاسترداد — هنحوّللك المبلغ عبر إنستاباي خلال 3–5 أيام عمل.',
