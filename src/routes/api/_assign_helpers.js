...
// ── /assign helpers (pure) ─────────────────────────────────────
// A4/A5 (fix plan 2026-09-15): doctorSupportsTier and capFor moved VERBATIM to
// services/doctor_eligibility.js so the doctor-side gates (the case-page offer
// rule and the pool accept) can share them without a services→routes require.
// Re-exported here so every existing admin/assign caller is untouched; their
// full history and rationale travelled with them.
const { doctorSupportsTier, capFor } = require('../../services/doctor_eligibility');
